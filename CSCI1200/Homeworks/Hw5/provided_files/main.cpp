...
void StudentTests() {
  ...
  TrainCar* z;
  z = NULL;
  PushBack(z, TrainCar::MakeEngine()); 
  PushBack(z, TrainCar::MakePassengerCar());
  PushBack(z, TrainCar::MakePassengerCar());
  PushBack(z, TrainCar::MakePassengerCar());
  PushBack(z, TrainCar::MakeSleepingCar());
  PushBack(z, TrainCar::MakeDiningCar());
  PushBack(z, TrainCar::MakePassengerCar());
  PushBack(z, TrainCar::MakeEngine());
  PushBack(z, TrainCar::MakePassengerCar());
  PushBack(z, TrainCar::MakeDiningCar());
  ...
  MTRand_int32 mtrand_fixed_seed(13);
  ShipFreightHelper(mtrand_fixed_seed,13,25,65,11);
