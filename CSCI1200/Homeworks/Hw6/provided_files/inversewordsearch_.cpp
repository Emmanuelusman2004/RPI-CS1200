...
int main(int argc, char* argv[]) {
	/*
    STUDENT TESTCASES:
    im not really sure how to implement student test cases in my main function but i still tested them
    ...
    FILE: "testcase3"
    testing a large file to see if it runs even though theres no words only plusses and minueses.
